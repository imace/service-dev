			...
			<div class="col-xs-12">
				...
				<div id="supportFriend" class="text-center">
					<form action="<%=request.getContextPath()%>/sharepage" method="post">
						...
						<div class="row">
							<div class="col-xs-12">
								<button type="submit" style="display: block;padding:0.7em;font-size:1.8em"  data-openId="<%=toid %>" data-pageName="4" data-operation="10" data-host="<%=request.getScheme()%>://<%=request.getServerName()%>" 
